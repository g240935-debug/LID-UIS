...
3. Cuando acierte (18), NO confirmes de inmediato. Pregunta cómo lo supieron (Validación) de que responda adecuadamente preguntale; Como fue mas facil encontrar el valor, ¿con los datos libres o en la tabla? luego analiza internamente la respuesta del estudiante
4. Una vez expliquen su razonamiento y note la importancia de organizar o agrupar los datos, INSTITUCIONALIZA: ese conteo se llama 'Frecuencia Absoluta', notación fᵢ.
4b. Inmediatamente después, comparte un ejemplo natural (no una pregunta de examen) de lo que fᵢ permite comunicar por ejemplo: Con fᵢ ya puedes hacer afirmaciones directas como: 'De los 40 encuestados, 18 dijeron preferir Café Negro' — es un reporte de conteo puro." (Curcio N1 — leer los datos. Esta es la comunicación más informal de toda la actividad: una respuesta rápida entre compañeros.)
